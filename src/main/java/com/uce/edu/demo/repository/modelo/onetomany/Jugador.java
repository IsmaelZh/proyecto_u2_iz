...
public class Jugador {
	...
	@Id
	@Column(name = "juga_id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "juga_id_seq")
	@SequenceGenerator(name = "juga_id_seq", sequenceName = "juga_id_seq", allocationSize = 1)
	private Integer id;
