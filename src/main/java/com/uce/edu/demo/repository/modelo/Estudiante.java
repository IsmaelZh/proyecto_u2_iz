...
@NamedNativeQuery(name = "Estudiante.BuscarPorEdadNative", query = "SELECT * FROM estudiante WHERE estu_edad > :datoEdad ORDER BY estu_nombre asc", resultClass = Estudiante.class)
