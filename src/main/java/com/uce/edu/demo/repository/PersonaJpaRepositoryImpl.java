...
public class PersonaJpaRepositoryImpl implements IPersonaJpaRepository {
	...
	public Persona buscarPorCedulaCriteriaApi(String cedula) {
       ...
       TypedQuery myQuery.select(personaRoot).where(myBuilder.equal(personaRoot.get("cedula"), cedula));
		
        this.entityManager.createQuery(cedula)*/
		return null;
	}
	...
	@Override
	public int actualizarPorApellido(String genero, String apellido) { // int si se requiere saber cuantos se
																		// actualizaron, caso contrario VOID
		// TODO Auto-generated method stub
